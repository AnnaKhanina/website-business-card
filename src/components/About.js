            ...
            <div>
              ...
              <div className="about-text-wrap">
                <p className="about-text">
                  ...
                  <br />
                  <br /> Завітайте до нас і насолоджуйтеся унікальною
                  атмосферою. У нашому асортименті кожен знайде щось для себе:
                  від насичених темних сортів пива до легких та освіжаючих
                  лимонадів. Крафтові напої створені з любов’ю та майстерністю,
                  щоб кожен ковток дарував незабутні враження.
                  <br />
                  <br />
